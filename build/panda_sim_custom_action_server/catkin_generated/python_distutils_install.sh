...
echo_and_run /usr/bin/env \
    PYTHONPATH="/home/morgan/projects/cws_ws/install/lib/python2.7/dist-packages:/home/morgan/projects/cws_ws/build/panda_sim_custom_action_server/lib/python2.7/dist-packages:$PYTHONPATH" \
    CATKIN_BINARY_DIR="/home/morgan/projects/cws_ws/build/panda_sim_custom_action_server" \
    "/usr/bin/python2" \
    "/home/morgan/projects/cws_ws/src/panda_simulator/panda_sim_custom_action_server/setup.py" \
     \
    build --build-base "/home/morgan/projects/cws_ws/build/panda_sim_custom_action_server" \
    install \
    --root="${DESTDIR-/}" \
