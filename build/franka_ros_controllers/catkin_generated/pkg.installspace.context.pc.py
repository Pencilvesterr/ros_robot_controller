...
PKG_CONFIG_LIBRARIES_WITH_PREFIX = "-lfranka_ros_controllers;/home/hrigroup2/git/libfranka/build/libfranka.so.0.7.1".split(';') if "-lfranka_ros_controllers;/home/hrigroup2/git/libfranka/build/libfranka.so.0.7.1" != "" else []
