...
if __name__ == '__main__':
    ...
    pick_goal_test = create_pose_stamped(create_pose(-0.023638638448843095 - 0.02, 0.548079862923556, 0.05, -1, 0, 0, 0), "panda_link0") 
    ...
    object_test_pose = create_pose_stamped(create_pose(-0.023638638448843095 - 0.02, 0.548079862923556, 0.04435475238631975, -1, 0, 0, 0), "panda_link0") 
    ...
    try:
        ...
        result = call_server("pick_and_place", pick_goal_test, place_goal_test, "spam")
