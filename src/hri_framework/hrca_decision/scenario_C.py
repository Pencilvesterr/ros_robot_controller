...
########################################################################################################################################################
#                                                        SCENARIO C - ERROR WITHOUT EXPLANATION                                                        #
########################################################################################################################################################  
...
def box1():
    ...
    # PICK AND PLACE OBJECTS 
    p1 = subprocess.Popen(["mpg321", "--gain", "30", PREFIX_PATH + "I.mp3"], shell=False, stdout=subprocess.PIPE, stderr=devnull)
    time.sleep(0.5)
    p2 = subprocess.Popen(["mpg321", "--gain", "30", PREFIX_PATH + "first_object.mp3"], shell=False, stdout=subprocess.PIPE, stderr=devnull)
    while p2.poll() is None:
        time.sleep(0.1)
    ...
    p1 = subprocess.Popen(["mpg321", "--gain", "30", PREFIX_PATH + "I.mp3"], shell=False, stdout=subprocess.PIPE, stderr=devnull)
    time.sleep(0.5)
    p2 = subprocess.Popen(["mpg321", "--gain", "30", PREFIX_PATH + "second_object.mp3"], shell=False, stdout=subprocess.PIPE, stderr=devnull)
    while p2.poll() is None:
        time.sleep(0.1)
    ...
    p1 = subprocess.Popen(["mpg321", "--gain", "30", PREFIX_PATH + "I.mp3"], shell=False, stdout=subprocess.PIPE, stderr=devnull)
    time.sleep(0.5)
    p2 = subprocess.Popen(["mpg321", "--gain", "30", PREFIX_PATH + "third_object.mp3"], shell=False, stdout=subprocess.PIPE, stderr=devnull)
    while p2.poll() is None:
        time.sleep(0.1)
    ...
    p1 = subprocess.Popen(["mpg321", "--gain", "30", PREFIX_PATH + "I.mp3"], shell=False, stdout=subprocess.PIPE, stderr=devnull)
    time.sleep(0.5)
    p2 = subprocess.Popen(["mpg321", "--gain", "30", PREFIX_PATH + "last_object.mp3"], shell=False, stdout=subprocess.PIPE, stderr=devnull)
    while p2.poll() is None:
        time.sleep(0.1)
    ...
    p1 = subprocess.Popen(["mpg321", "--gain", "30", PREFIX_PATH + "I.mp3"], shell=False, stdout=subprocess.PIPE, stderr=devnull)
    time.sleep(0.5)
    p2 = subprocess.Popen(["mpg321", "--gain", "30", PREFIX_PATH + "finish.mp3"], shell=False, stdout=subprocess.PIPE, stderr=devnull)
    while p2.poll() is None:
        time.sleep(0.1)
...
def box2():
    ...
    [muesli_pose, muesli_pick, muesli_place] = get_object_info(item_size, pub, "MUESLI", "mistake", row1_x, "stack")
...
def box4():
    ...
    [muesli2_pose, muesli2_pick, muesli2_place] = get_object_info(item_size, pub, "MUESLI2", "second", row1_x)
