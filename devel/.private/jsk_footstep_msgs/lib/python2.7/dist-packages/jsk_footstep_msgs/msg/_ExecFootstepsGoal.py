...
"""autogenerated by genpy from jsk_footstep_msgs/ExecFootstepsGoal.msg. Do not edit."""
import codecs
import sys
...
class ExecFootstepsGoal(genpy.Message):
  _md5sum = "bb8b96be7f0085372e05a467f65017bb"
  _type = "jsk_footstep_msgs/ExecFootstepsGoal"
...
float64 z"""
  ...
  __slots__ = ['footstep','strategy']
  _slot_types = ['jsk_footstep_msgs/FootstepArray','uint8']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.footstep is None:
        self.footstep = jsk_footstep_msgs.msg.FootstepArray()
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_3I().pack(_x.footstep.header.seq, _x.footstep.header.stamp.secs, _x.footstep.header.stamp.nsecs))
      _x = self.footstep.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.footstep.footsteps)
      buff.write(_struct_I.pack(length))
      for val1 in self.footstep.footsteps:
        _x = val1.leg
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.footstep.header.seq, _x.footstep.header.stamp.secs, _x.footstep.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      ...
      if python3:
        self.footstep.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.footstep.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.footstep.footsteps = []
      for i in range(0, length):
        ...
        self.footstep.footsteps.append(val1)
      start = end
      end += 1
      (self.strategy,) = _get_struct_B().unpack(str[start:end])
      return self
