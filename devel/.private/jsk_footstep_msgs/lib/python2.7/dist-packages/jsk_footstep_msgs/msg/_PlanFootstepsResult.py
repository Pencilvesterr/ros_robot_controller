...
"""autogenerated by genpy from jsk_footstep_msgs/PlanFootstepsResult.msg. Do not edit."""
import codecs
import sys
...
class PlanFootstepsResult(genpy.Message):
  _md5sum = "951c674749b5b8b08d5eba2e3e62aedd"
  _type = "jsk_footstep_msgs/PlanFootstepsResult"
...
float64 z"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlanFootstepsResult, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.result is None:
        self.result = jsk_footstep_msgs.msg.FootstepArray()
    else:
      self.result = jsk_footstep_msgs.msg.FootstepArray()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.result.footsteps)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.footsteps:
        _x = val1.leg
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.result.footsteps.append(val1)
      return self
