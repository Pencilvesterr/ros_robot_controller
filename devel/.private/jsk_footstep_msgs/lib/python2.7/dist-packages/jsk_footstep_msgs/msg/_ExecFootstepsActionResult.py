...
"""autogenerated by genpy from jsk_footstep_msgs/ExecFootstepsActionResult.msg. Do not edit."""
import codecs
import sys
...
class ExecFootstepsActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "jsk_footstep_msgs/ExecFootstepsActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','jsk_footstep_msgs/ExecFootstepsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ExecFootstepsActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = jsk_footstep_msgs.msg.ExecFootstepsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = jsk_footstep_msgs.msg.ExecFootstepsResult()
