...
"""autogenerated by genpy from jsk_footstep_msgs/ExecFootstepsAction.msg. Do not edit."""
import codecs
import sys
...
class ExecFootstepsAction(genpy.Message):
  _md5sum = "c92f25369ce56498a9f7b060b84a87e6"
  _type = "jsk_footstep_msgs/ExecFootstepsAction"
...
"""
  ...
  _slot_types = ['jsk_footstep_msgs/ExecFootstepsActionGoal','jsk_footstep_msgs/ExecFootstepsActionResult','jsk_footstep_msgs/ExecFootstepsActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ExecFootstepsAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = jsk_footstep_msgs.msg.ExecFootstepsActionGoal()
      if self.action_result is None:
        self.action_result = jsk_footstep_msgs.msg.ExecFootstepsActionResult()
      if self.action_feedback is None:
        self.action_feedback = jsk_footstep_msgs.msg.ExecFootstepsActionFeedback()
    else:
      self.action_goal = jsk_footstep_msgs.msg.ExecFootstepsActionGoal()
      self.action_result = jsk_footstep_msgs.msg.ExecFootstepsActionResult()
      self.action_feedback = jsk_footstep_msgs.msg.ExecFootstepsActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3I().pack(_x.action_goal.goal.footstep.header.seq, _x.action_goal.goal.footstep.header.stamp.secs, _x.action_goal.goal.footstep.header.stamp.nsecs))
      _x = self.action_goal.goal.footstep.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.action_goal.goal.footstep.footsteps)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.footstep.footsteps:
        _x = val1.leg
      ...
      _x = self
      buff.write(_get_struct_B3I().pack(_x.action_goal.goal.strategy, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.footstep.header.seq, _x.action_goal.goal.footstep.header.stamp.secs, _x.action_goal.goal.footstep.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.footstep.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.footstep.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.footstep.footsteps = []
      for i in range(0, length):
        ...
        self.action_goal.goal.footstep.footsteps.append(val1)
      _x = self
      start = end
      end += 13
      (_x.action_goal.goal.strategy, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_B3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
