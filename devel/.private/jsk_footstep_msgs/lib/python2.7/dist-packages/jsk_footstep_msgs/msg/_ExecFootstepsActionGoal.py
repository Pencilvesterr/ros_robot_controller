...
"""autogenerated by genpy from jsk_footstep_msgs/ExecFootstepsActionGoal.msg. Do not edit."""
import codecs
import sys
...
class ExecFootstepsActionGoal(genpy.Message):
  _md5sum = "38576fea93f66a22a5349190d02ffd87"
  _type = "jsk_footstep_msgs/ExecFootstepsActionGoal"
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','jsk_footstep_msgs/ExecFootstepsGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = jsk_footstep_msgs.msg.ExecFootstepsGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = jsk_footstep_msgs.msg.ExecFootstepsGoal()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3I().pack(_x.goal.footstep.header.seq, _x.goal.footstep.header.stamp.secs, _x.goal.footstep.header.stamp.nsecs))
      _x = self.goal.footstep.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.goal.footstep.footsteps)
      buff.write(_struct_I.pack(length))
      for val1 in self.goal.footstep.footsteps:
        _x = val1.leg
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.footstep.header.seq, _x.goal.footstep.header.stamp.secs, _x.goal.footstep.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.goal.footstep.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.goal.footstep.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.goal.footstep.footsteps = []
      for i in range(0, length):
        ...
        self.goal.footstep.footsteps.append(val1)
      start = end
      end += 1
      (self.goal.strategy,) = _get_struct_B().unpack(str[start:end])
      return self
