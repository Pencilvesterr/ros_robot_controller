...
"""autogenerated by genpy from jsk_footstep_msgs/PlanFootstepsActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class PlanFootstepsActionFeedback(genpy.Message):
  _md5sum = "c827ac0ba59dca5c1bf7b9bb97d2a1ae"
  _type = "jsk_footstep_msgs/PlanFootstepsActionFeedback"
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','jsk_footstep_msgs/PlanFootstepsFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlanFootstepsActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = jsk_footstep_msgs.msg.PlanFootstepsFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = jsk_footstep_msgs.msg.PlanFootstepsFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3I().pack(_x.feedback.feedback.header.seq, _x.feedback.feedback.header.stamp.secs, _x.feedback.feedback.header.stamp.nsecs))
      _x = self.feedback.feedback.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.feedback.feedback.footsteps)
      buff.write(_struct_I.pack(length))
      for val1 in self.feedback.feedback.footsteps:
        _x = val1.leg
        buff.write(_get_struct_B().pack(_x))
        _v1 = val1.pose
        _v2 = _v1.position
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.feedback.header.seq, _x.feedback.feedback.header.stamp.secs, _x.feedback.feedback.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.feedback.feedback.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.feedback.feedback.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.feedback.feedback.footsteps = []
      for i in range(0, length):
        ...
        self.feedback.feedback.footsteps.append(val1)
      return self
