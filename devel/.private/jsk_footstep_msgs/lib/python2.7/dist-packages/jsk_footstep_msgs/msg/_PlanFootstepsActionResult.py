...
"""autogenerated by genpy from jsk_footstep_msgs/PlanFootstepsActionResult.msg. Do not edit."""
import codecs
import sys
...
class PlanFootstepsActionResult(genpy.Message):
  _md5sum = "12a9334ae88f7e7881a5ffdea1dd3de1"
  _type = "jsk_footstep_msgs/PlanFootstepsActionResult"
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','jsk_footstep_msgs/PlanFootstepsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlanFootstepsActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = jsk_footstep_msgs.msg.PlanFootstepsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = jsk_footstep_msgs.msg.PlanFootstepsResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3I().pack(_x.result.result.header.seq, _x.result.result.header.stamp.secs, _x.result.result.header.stamp.nsecs))
      _x = self.result.result.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.result.result.footsteps)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.result.footsteps:
        _x = val1.leg
        buff.write(_get_struct_B().pack(_x))
        _v1 = val1.pose
        _v2 = _v1.position
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.result.header.seq, _x.result.result.header.stamp.secs, _x.result.result.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.result.result.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.result.result.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.result.result.footsteps = []
      for i in range(0, length):
        ...
        self.result.result.footsteps.append(val1)
      return self
