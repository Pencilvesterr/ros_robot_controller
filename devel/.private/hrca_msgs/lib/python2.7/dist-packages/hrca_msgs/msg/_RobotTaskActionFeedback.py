...
"""autogenerated by genpy from hrca_msgs/RobotTaskActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class RobotTaskActionFeedback(genpy.Message):
  _md5sum = "82e97615735594b25e2cee3da22d3eb7"
  _type = "hrca_msgs/RobotTaskActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hrca_msgs/RobotTaskFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RobotTaskActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = hrca_msgs.msg.RobotTaskFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = hrca_msgs.msg.RobotTaskFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.feedback.status = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.feedback.status = str[start:end]
      return self
