...
"""autogenerated by genpy from hrca_msgs/RobotTaskActionResult.msg. Do not edit."""
import codecs
import sys
...
class RobotTaskActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "hrca_msgs/RobotTaskActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hrca_msgs/RobotTaskResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RobotTaskActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = hrca_msgs.msg.RobotTaskResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = hrca_msgs.msg.RobotTaskResult()
