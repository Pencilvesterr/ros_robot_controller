...
"""autogenerated by genpy from hrca_decision/TrafficLight.msg. Do not edit."""
import codecs
import sys
...
class TrafficLight(genpy.Message):
  ...
  _type = "hrca_decision/TrafficLight"
...
int32 zone_status"""
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       block_selected,block_status,zone_selected,zone_status
    ...
    if args or kwds:
      ...
      if self.block_selected is None:
        self.block_selected = 0
      if self.block_status is None:
        self.block_status = 0
      if self.zone_selected is None:
