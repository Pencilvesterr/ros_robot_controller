...
(cl:defmethod cl:initialize-instance :after ((m <TrafficLight>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TrafficLight)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hrca_decision-msg:<TrafficLight> is deprecated: use hrca_decision-msg:TrafficLight instead.")))

(cl:ensure-generic-function 'block_selected-val :lambda-list '(m))
(cl:defmethod block_selected-val ((m <TrafficLight>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hrca_decision-msg:block_selected-val is deprecated.  Use hrca_decision-msg:block_selected instead.")
  (block_selected m))

(cl:ensure-generic-function 'block_status-val :lambda-list '(m))
(cl:defmethod block_status-val ((m <TrafficLight>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hrca_decision-msg:block_status-val is deprecated.  Use hrca_decision-msg:block_status instead.")
  (block_status m))

(cl:ensure-generic-function 'zone_selected-val :lambda-list '(m))
(cl:defmethod zone_selected-val ((m <TrafficLight>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hrca_decision-msg:zone_selected-val is deprecated.  Use hrca_decision-msg:zone_selected instead.")
  (zone_selected m))

(cl:ensure-generic-function 'zone_status-val :lambda-list '(m))
(cl:defmethod zone_status-val ((m <TrafficLight>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hrca_decision-msg:zone_status-val is deprecated.  Use hrca_decision-msg:zone_status instead.")
  (zone_status m))
