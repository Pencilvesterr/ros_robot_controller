...
(cl:defmethod cl:initialize-instance :after ((m <MoveBlock-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveBlock-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cws_planning-srv:<MoveBlock-request> is deprecated: use cws_planning-srv:MoveBlock-request instead.")))

(cl:ensure-generic-function 'block_number-val :lambda-list '(m))
(cl:defmethod block_number-val ((m <MoveBlock-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cws_planning-srv:block_number-val is deprecated.  Use cws_planning-srv:block_number instead.")
  (block_number m))

(cl:ensure-generic-function 'block_zone-val :lambda-list '(m))
(cl:defmethod block_zone-val ((m <MoveBlock-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cws_planning-srv:block_zone-val is deprecated.  Use cws_planning-srv:block_zone instead.")
  (block_zone m))
...
(cl:defmethod cl:initialize-instance :after ((m <MoveBlock-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveBlock-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cws_planning-srv:<MoveBlock-response> is deprecated: use cws_planning-srv:MoveBlock-response instead.")))
