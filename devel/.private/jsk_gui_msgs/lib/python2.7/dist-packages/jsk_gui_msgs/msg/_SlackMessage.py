...
"""autogenerated by genpy from jsk_gui_msgs/SlackMessage.msg. Do not edit."""
import codecs
import sys
...
class SlackMessage(genpy.Message):
  _md5sum = "b68991d3b722980bd0f3eeeeee52635b"
  _type = "jsk_gui_msgs/SlackMessage"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """string channel           # channel to post (ex. @user, #general)
...
string frame_id
"""
  __slots__ = ['channel','text','image']
  _slot_types = ['string','string','sensor_msgs/Image']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SlackMessage, self).__init__(*args, **kwds)
