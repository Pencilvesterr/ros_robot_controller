...
"""autogenerated by genpy from jsk_gui_msgs/Touch.msg. Do not edit."""
import codecs
import sys
...
class Touch(genpy.Message):
  _md5sum = "d96a284d39fcc410f375ac68fd380177"
  _type = "jsk_gui_msgs/Touch"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# finger_id
int64 finger_id
...
int64 image_width
int64 image_height"""
  __slots__ = ['finger_id','x','y','image_width','image_height']
  _slot_types = ['int64','float64','float64','int64','int64']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Touch, self).__init__(*args, **kwds)
