...
namespace franka_example_controllers
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(teleop_gripper_paramConfig &config, const teleop_gripper_paramConfig &max, const teleop_gripper_paramConfig &min) const
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const teleop_gripper_paramConfig &config1, const teleop_gripper_paramConfig &config2) const
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, teleop_gripper_paramConfig &config) const
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const teleop_gripper_paramConfig &config) const
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, teleop_gripper_paramConfig &config) const
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const teleop_gripper_paramConfig &config) const
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const teleop_gripper_paramConfig &config, boost::any &val) const
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, teleop_gripper_paramConfig &top) const
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 12 "/home/hrigroup2/projects/ros_cws_planner/src/franka_ros/franka_example_controllers/cfg/teleop_gripper_param.cfg"
      double grasp_force;
//#line 15 "/home/hrigroup2/projects/ros_cws_planner/src/franka_ros/franka_example_controllers/cfg/teleop_gripper_param.cfg"
      double move_speed;
