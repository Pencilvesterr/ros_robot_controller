...
"""autogenerated by genpy from robohub_object_tracking/TrackedObjectPose.msg. Do not edit."""
import codecs
import sys
...
class TrackedObjectPose(genpy.Message):
  _md5sum = "ca24679b18012554617c5552db286b5e"
  _type = "robohub_object_tracking/TrackedObjectPose"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# Used to hold data for each message. The '...List' message is the one actually used.
string id
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrackedObjectPose, self).__init__(*args, **kwds)
