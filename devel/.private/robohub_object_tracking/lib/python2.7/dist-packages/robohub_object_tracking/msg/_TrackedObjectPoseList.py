...
"""autogenerated by genpy from robohub_object_tracking/TrackedObjectPoseList.msg. Do not edit."""
import codecs
import sys
...
import robohub_object_tracking.msg
import std_msgs.msg

class TrackedObjectPoseList(genpy.Message):
  _md5sum = "426728e80dadb19a5b9479f4048ea61c"
  _type = "robohub_object_tracking/TrackedObjectPoseList"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """robohub_object_tracking/TrackedObjectPose[] object_list
================================================================================
...
"""
  ...
  _slot_types = ['robohub_object_tracking/TrackedObjectPose[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrackedObjectPoseList, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = robohub_object_tracking.msg.TrackedObjectPose()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
