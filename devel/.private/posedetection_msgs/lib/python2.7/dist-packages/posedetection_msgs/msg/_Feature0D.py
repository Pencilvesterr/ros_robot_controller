...
"""autogenerated by genpy from posedetection_msgs/Feature0D.msg. Do not edit."""
import codecs
import sys
...
class Feature0D(genpy.Message):
  _md5sum = "fcb3ba42a42cf972f3838cdb171f5e04"
  _type = "posedetection_msgs/Feature0D"
...
string frame_id
"""
  __slots__ = ['header','positions','scales','orientations','confidences','descriptors','descriptor_dim','type']
  _slot_types = ['std_msgs/Header','float32[]','float32[]','float32[]','float32[]','float32[]','int32','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,positions,scales,orientations,confidences,descriptors,descriptor_dim,type
    ...
    """
    if args or kwds:
      super(Feature0D, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.scales))
      length = len(self.orientations)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.orientations))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.scales = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.orientations = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(self.scales.tostring())
      length = len(self.orientations)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.scales = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
