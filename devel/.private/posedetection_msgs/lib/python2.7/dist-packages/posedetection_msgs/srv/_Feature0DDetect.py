...
"""autogenerated by genpy from posedetection_msgs/Feature0DDetectRequest.msg. Do not edit."""
import codecs
import sys
...
class Feature0DDetectRequest(genpy.Message):
  _md5sum = "b13d2865c5af2a64e6e30ab1b56e1dd5"
  _type = "posedetection_msgs/Feature0DDetectRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Feature0DDetectRequest, self).__init__(*args, **kwds)
...
def _get_struct_BI():
    ...
    return _struct_BI
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from posedetection_msgs/Feature0DDetectResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class Feature0DDetectResponse(genpy.Message):
  _md5sum = "fa5677bbe36e6cfb2be31b9bbea8bcae"
  _type = "posedetection_msgs/Feature0DDetectResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """posedetection_msgs/Feature0D features
...
"""
  __slots__ = ['features']
  _slot_types = ['posedetection_msgs/Feature0D']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Feature0DDetectResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.features is None:
        self.features = posedetection_msgs.msg.Feature0D()
    else:
      self.features = posedetection_msgs.msg.Feature0D()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.features.positions)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.features.positions))
      length = len(self.features.scales)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.features.scales))
      length = len(self.features.orientations)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.features.orientations))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.features.positions = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.features.scales = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.features.orientations = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      if python3:
        self.features.type = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.features.type = str[start:end]
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(self.features.positions.tostring())
      length = len(self.features.scales)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(self.features.scales.tostring())
      length = len(self.features.orientations)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(self.features.orientations.tostring())
      length = len(self.features.confidences)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.features.positions = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.features.scales = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.features.orientations = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
...
def _get_struct_i():
    ...
    return _struct_i
class Feature0DDetect(object):
  _type          = 'posedetection_msgs/Feature0DDetect'
  _md5sum = 'abc004df074d18a6645a71894c243592'
  _request_class  = Feature0DDetectRequest
  _response_class = Feature0DDetectResponse
