...
"""autogenerated by genpy from posedetection_msgs/DetectRequest.msg. Do not edit."""
import codecs
import sys
...
class DetectRequest(genpy.Message):
  _md5sum = "bfee1901edaf2aa4d9f0844a03ff634f"
  _type = "posedetection_msgs/DetectRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# service that passes an image and gets object detection results
...
def _get_struct_BI():
    ...
    return _struct_BI
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from posedetection_msgs/DetectResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class DetectResponse(genpy.Message):
  _md5sum = "7b25cb2a35e9a4692af3117eeddab11b"
  _type = "posedetection_msgs/DetectResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """ObjectDetection object_detection
...
"""
  ...
  _slot_types = ['posedetection_msgs/ObjectDetection']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.object_detection is None:
        self.object_detection = posedetection_msgs.msg.ObjectDetection()
    else:
      self.object_detection = posedetection_msgs.msg.ObjectDetection()
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_3I().pack(_x.object_detection.header.seq, _x.object_detection.header.stamp.secs, _x.object_detection.header.stamp.nsecs))
      _x = self.object_detection.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.object_detection.objects)
      buff.write(_struct_I.pack(length))
      for val1 in self.object_detection.objects:
        _v1 = val1.pose
        _v2 = _v1.position
        _x = _v2
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.object_detection.header.seq, _x.object_detection.header.stamp.secs, _x.object_detection.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.object_detection.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.object_detection.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.object_detection.objects = []
      for i in range(0, length):
        val1 = posedetection_msgs.msg.Object6DPose()
        _v4 = val1.pose
        _v5 = _v4.position
        _x = _v5
        start = end
        ...
        (val1.reliability,) = _get_struct_f().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        self.object_detection.objects.append(val1)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
...
def _get_struct_f():
    ...
    return _struct_f
class Detect(object):
  _type          = 'posedetection_msgs/Detect'
  _md5sum = '2842f62c8f4b2243a0b05de2cc82488b'
