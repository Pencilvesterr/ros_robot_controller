...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'object_tracking_wrappers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/morgan/projects/ros_cws_planner/src/hri_framework/hrca_dependencies/ros_object_tracking_utilities/object_tracking_wrappers/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/morgan/projects/ros_cws_planner/devel/.private/object_tracking_wrappers/lib;/home/morgan/projects/ros_cws_planner/devel/lib;/opt/ros/melodic/lib)
